...
class dataingestion:
    ...
    def initiate_data_ingestion(self):
        ...
        try:
            df=pd.read_csv('notebook\data\students data.csv')
...
if __name__=="__main__":
    ...
    train_arr,test_arr,_=data_transformation.initiate_data_transformation(train_data,test_data)   #initiate data transformation
